...
urlpatterns = [
    ...
    path('car/<int:car_id>/edit_review/<int:review_id>/', views.edit_review, name='edit_review'),
    path('car/<int:car_id>/delete_review/<int:review_id>/', views.delete_review, name='delete_review'),
